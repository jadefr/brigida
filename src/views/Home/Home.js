    ...
    return (
        <div>
            ...
            <div className="home__row">
                ...
                <p className="text">Em seu leito mortuário, Brígida sorria e espalhava a calma e a paz. Morreu no dia 24 de Agosto de 1930, aos 28 anos, em ares de santidade. </p>
                <p className="text">Quase cem anos após sua morte, Brígida continua a interceder por Angustura e àqueles que pedem sua intercessão.</p>
            </div>
        </div>
    );
}
